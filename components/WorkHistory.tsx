...
export default function WorkHistory() {
  return (
    <section id="history" className="py-24 px-6 bg-[#0c0a13]">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative border-l border-[#1e1a2e] ml-4 md:ml-0 md:border-l-0">
          {history.map((h, i) => (
            <div key={i} className="md:grid md:grid-cols-[200px_1fr] gap-8 mb-12">
              ...
              <div className="bg-[#110e1e] border border-[#1e1a2e] rounded-2xl p-6 ml-8 md:ml-0 relative">
